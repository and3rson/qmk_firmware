...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAIN] = LAYOUT_split_3x6_3( \
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL, \
                                   KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  LT(KC_BETA, KC_EQL), KC_QUOT \
    ),
    ...
    [_BETA] = LAYOUT_split_3x6_3( \
        ...
        _______, QK_BOOT, _______, _______, _______, KC_SET_TIME,KC_SLEP,_______,KC_LCBR,KC_RCBR, KC_PSCR, _______, \
                                   _______, _______, _______, _______, _______, _______ \
    )
};
